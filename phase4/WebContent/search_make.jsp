								...
								<tr class="row100 head">
									<%
										...
										try {
											...
											sql = "SELECT V.Model_year as year, V.Mileage , V.Price, V.Vnumber as vnum, V.Make_code as make, V.Model_num as model, V.Dm_num as detailed, V.Cname1 as color1, V.Cname2 as color2, V.Engine_amount as engine, V.Fcode1 as fuel1, V.Fcode2 as fuel2, V.Category_code as category, V.Tcode as transmission "
													+ " FROM VEHICLE V JOIN MAKE M ON V.Make_code=M.Mcode WHERE M.Mname = '" + SearchMake
													+ "' AND V.Ac_id IS NULL AND Notopen = 1 ORDER BY Vnumber";
