								...
								<tr class="row100 head">
									<%
										...
										try {
											...
											sql = "SELECT V.Model_year, V.Mileage, V.Price, V.Vnumber, V.Make_code, V.Model_num, V.Dm_num, V.Cname1, V.Cname2, V.Engine_amount, V.Fcode1, V.Fcode2, V.Category_code, V.Tcode, V.Ac_id FROM VEHICLE V JOIN Detailed_model D ON V.Dm_num=D.Dmnumber WHERE V.Ac_id IS NULL AND V.Notopen = 1 AND D.Dmname = '"
													+ SearchCarname + "'";
